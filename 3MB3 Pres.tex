...
\vspace{0.1cm}
        ...
        \begin{itemize}
            ...
            % behaviour based on ratio $bd$ vs $ac$
                % In this model, long-term outcomes depend only on how the two countries' combined fear compares to their combined tendency to preserve spending.
            ...
            % Model behaviour changes based on initial spending which impacts equilibrium so stable positive spending is more common
