...
\begin{frame}{Base Model}
    \begin{block}{Model Equations}
        ...
        \begin{align*}
        \dfrac{\partial p}{\partial t} &= a g(t) - b p(t) \\
        % \Delta p &= a g(t) - b p(t) \\
        \dfrac{\partial g}{\partial t} &= c p(t) - d g(t)
        % \Delta g &= c p(t) - d g(t)
        \end{align*}
    \end{block}
    \begin{itemize}
...
\vspace{0.1cm}
    ...
    \begin{columns}
        ...
        \includegraphics[width=0.75\textwidth]{S7_bd_eq_ac.png}\\
        \tiny Trajectories never reach equilibrium
        \column{0.33\textwidth}
        \centering
        \textbf{\small $bd=ac, r<0, s<0$}\\
        \includegraphics[width=0.75\textwidth]{S5_bd_eq_ac.png}\\
        \tiny Complete mutual disarmament
        \column{0.33\textwidth}
        \centering
        \textbf{\small $bd=ac, r>0, s>0$}\\
        \includegraphics[width=0.75\textwidth]{S6_bd_eq_ac.png}\\
...
\vspace{0.1cm}
    ...
    \begin{columns}
        ...
        \tiny One grows, one shrinks
        \column{0.5\textwidth}
        \centering
        \textbf{\small $bd=ac, r=0, s>0$}\\
        \includegraphics[width=0.5\textwidth]{S3_bd_eq_ac.png}\\
        \tiny Both diverge
    \end{columns}
...
% \vspace{0.3cm}
    \begin{block}{Model Equations}
        The equations after adding logistic growth to account of limited resources are:
   \begin{align*}
        \dfrac{\partial p}{\partial t} &= a(1-\frac{p(t)}{K_p})g(t) - b p(t) + r\\
        \dfrac{\partial g}{\partial t} &= c(1-\frac{g(t)}{K_g})p(t) - d g(t) + s
    \end{align*}
    \end{block}
