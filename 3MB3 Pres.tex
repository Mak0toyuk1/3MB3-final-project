...
\caption{DAG Diagram for the Base Model}
...
\caption{DAG Diagram for the Base Model Including Public Sentiment}
...
\caption{DAG Diagram for the Base Model Including Mutual Fear}
